========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet Test_OpenCV
========================================================================

AppWizard a créé cette application Test_OpenCV pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application Test_OpenCV.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé Test_OpenCV.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
